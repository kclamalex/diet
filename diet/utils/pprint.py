...
#     )
#     protein_a_cycle = (
#         protein_one_meal_portion_gram * days_of_week * num_of_meals * num_of_ppl
#     )
#     carbs_a_cycle = (
#         carbs_one_meal_portion_gram * days_of_week * num_of_meals * num_of_ppl
#     )
#
#     if protein.name == "egg":
#         avg_gram_per_egg = 68
...
#         result = f"{protein.name}: {num_of_egg}, {carbohydrate.name}: {carbs_a_cycle}g"
#     else:
